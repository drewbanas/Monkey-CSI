namespace evaluator
{
    ...
    using ast;
    //using Object; // "using Object" causes ambiguity
    ...
    struct evaluator
    {
        ...
        {
            if (left.Type() == Object._ObjectType.INTEGER_OBJ && right.Type() == Object._ObjectType.INTEGER_OBJ)
                return evalIntegerInfixExpression(operator_, left, right);

            if (left.Type() == Object._ObjectType.STRING_OBJ && right.Type() == Object._ObjectType.STRING_OBJ)
        ...
        {
            if (right.Type() != Object._ObjectType.INTEGER_OBJ)
            {
        ...
        static Object.Object evalIdentifier(ast.Identifier node, Object.Environment env)
        {
            ...
            if (builtins_.builtins.TryGetValue(node.Value, out builtin))
            {
                return builtin;
            }
        ...
        static bool isError(Object.Object obj)
        {
            if (obj != null)
            {
                return obj.Type() == Object._ObjectType.ERROR_OBJ;
            }
            return false;
        }
        ...
        {
            if (left.Type() == Object._ObjectType.ARRAY_OBJ && index.Type() == Object._ObjectType.INTEGER_OBJ)
                return evalArrayIndexExpression(left, index);

            if (left.Type() == Object._ObjectType.HASH_OBJ)
