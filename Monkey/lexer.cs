namespace lexer
{
    ...
    struct Lexer
    {
        ...
        {
            Token tok = new Token { Type = token.ILLEGAL, Literal = "" }; // default to an illegal token if scan fails
            ...
            switch (this.ch)
            {
                case '=':
                    if (this.peekChar() == '=')
                    {
                        ...
                        tok = new Token { Type = token.EQ, Literal = literal };
                    }
                    else
                    {
                ...
                case '!':
                    if (this.peekChar() == '=')
                    {
                        ...
                        this.readChar();
                        string literal = ch.ToString() + this.ch.ToString();
                        tok = new Token { Type = token.NOT_EQ, Literal = literal };
                    }
                    else
                    {
