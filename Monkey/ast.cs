namespace ast
{
    ...
    // Statements
    class LetStatement : Statement // converted to class since struct is not nullable
    {
    ...
    class ReturnStatement : Statement // converted to class since struct is not nullable
    {
    ...
    class BlockStatement : Statement // class since Alternative is compared to null
    {
    ...
    struct MacroLiteral : Expression // class because of casting with LetStatement in macro_expansion.addMacro
    {
        public token.Token Token; // The 'fn' token
        public List<Identifier> Parameters;
        public BlockStatement Body;
