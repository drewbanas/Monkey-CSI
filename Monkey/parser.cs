namespace parser
{
    ...
    using ast;   // these "using"'s are optional
    using lexer; // since prefix style of Go is maintained
    using token;
    ...
    struct Parser
    {
        ...
        static ast.Expression parseMacroLiteral()
        {
            ast.MacroLiteral lit = new ast.MacroLiteral { Token = curToken };
